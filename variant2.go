...
import (
	...
	"NLockwood999.github/final-project/internal/cookies"
)

//This is the second variant it incorporates the ability to
//******print the cookie with unique characters using base64 conversion
//++++++sign the cookie to make it tamper proof
